...
public class LiftingLidTest {
  ...
  public void verifyLengths() {
    ...
    BoxSpec box1 = new SimpleBox(200, 250, 250, Panel.PanelRole.liftingLid, 14, "", 10, tols);
    BoxSpec box2 = new SimpleBox(40, 50, 40, Panel.PanelRole.liftingLid, 7, "", 10, tols);
    BoxSpec box3 = new BasedBox(200, 250, 250, Panel.PanelRole.liftingLid, 14, "", 10, tols);
    BoxSpec box4 = new BasedBox(40, 50, 40, Panel.PanelRole.liftingLid, 7, "", 10, tols);
  ...
  public void verifyPanelRoles () {
    ...
    BoxSpec BasedBox = new BasedBox(200, 250, 250, Panel.PanelRole.liftingLid, 14, "", 10, tols);
    BoxSpec SimpleBox = new SimpleBox(40, 50, 40, Panel.PanelRole.liftingLid, 7, "", 10, tols);
    ...
    assertEquals(BasedBox.panels.get(4).role, Panel.PanelRole.liftingLid);
    assertEquals(BasedBox.panels.get(5).role, Panel.PanelRole.basedBottom);
    assertEquals(BasedBox.panels.get(6).role, Panel.PanelRole.innerLid);
    ...
    assertEquals(SimpleBox.panels.get(4).role, Panel.PanelRole.liftingLid);
  ...
  public void verifyEdgeRoles () {
    ...
    // top lid panel
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(4).edges.get(0));
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(4).edges.get(1));
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(4).edges.get(2));
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(4).edges.get(3));
    ...
    // inner lid panel
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(6).edges.get(0));
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(6).edges.get(1));
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(6).edges.get(2));
    assertEquals(Panel.EdgeRole.flatLid, simpleBox.panels.get(6).edges.get(3));
    ...
    // top lid panel
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(4).edges.get(0));
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(4).edges.get(1));
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(4).edges.get(2));
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(4).edges.get(3));
    ...
    // top lid panel
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(6).edges.get(0));
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(6).edges.get(1));
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(6).edges.get(2));
    assertEquals(Panel.EdgeRole.flatLid, basedBox.panels.get(6).edges.get(3));
  }
}
